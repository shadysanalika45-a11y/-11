package feathers.themes.steel.components
{
   ...
   public class SteelVScrollBarStyles
   {
      
      public function SteelVScrollBarStyles()
      {
      }
      ...
      public static function initialize(param1:BaseSteelTheme = undefined) : void
      {
         ...
         if(_loc3_.getStyleFunction(VScrollBar,null) == null)
         {
            _loc3_.setStyleFunction(VScrollBar,null,function(param1:VScrollBar):void
            {
