package feathers.themes.steel.components
{
   ...
   public class SteelTextCalloutStyles
   {
      
      public function SteelTextCalloutStyles()
      {
      }
      ...
      public static function initialize(param1:BaseSteelTheme = undefined) : void
      {
         ...
         if(_loc3_.getStyleFunction(TextCallout,null) == null)
         {
            _loc3_.setStyleFunction(TextCallout,null,function(param1:TextCallout):void
            {
         ...
         if(_loc3_.getStyleFunction(TextCallout,TextCallout.VARIANT_DANGER) == null)
         {
            _loc3_.setStyleFunction(TextCallout,TextCallout.VARIANT_DANGER,function(param1:TextCallout):void
            {
               var _loc2_:* = null as RectangleSkin;
               var _loc3_:* = null as TriangleSkin;
               if(param1.get_textFormat() == null)
               ...
               if(param1.get_topArrowSkin() == null)
               {
                  ...
                  _loc3_.set_pointPosition(RelativePosition.TOP);
                  _loc3_.set_drawBaseBorder(false);
                  _loc3_.set_fill(theme.getDangerFill());
                  _loc3_.set_border(theme.getDangerBorder());
                  _loc3_.width = 10;
                  _loc3_.height = 6;
                  param1.set_topArrowSkin(_loc3_);
               }
