package as3reflect
{
   public class MetaDataContainer implements IMetaDataContainer
   {
      ...
      {
         super();
         this._metaData = param1 == null ? [] : param1;
      }
      ...
      public function getMetaData(param1:String) : Array
      {
         var _loc2_:Array = [];
         var _loc3_:int = 0;
         while(_loc3_ < this._metaData.length)
         {
            if(MetaData(this._metaData[_loc3_]).name == param1)
            {
               _loc2_.push(this._metaData[_loc3_]);
            }
            _loc3_++;
         }
         return _loc2_;
