package org.oyunstudyosu.components.hud.menu
{
   ...
   public class InventoryButton extends MainHudButton
   {
      ...
      {
         Connectr.instance.toolTipModel.addTip(this,$("Inventory"));
      }
      
      override protected function clicked() : void
      {
         hudEvent = new HudEvent(HudEvent.OPEN_INVENTORY_PANEL);
