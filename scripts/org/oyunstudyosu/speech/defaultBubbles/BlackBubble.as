package org.oyunstudyosu.speech.defaultBubbles
{
   ...
   public class BlackBubble extends BaseSpeechBubble implements ISpeechBubble
   {
      ...
      override public function speech(param1:String = "", param2:String = "") : void
      {
         ...
         sText.htmlText = "<font color=\"#cacaca\">" + param1 + ": " + "</font>" + "<font color=\"#fafafa\">" + param2 + "</font>";
