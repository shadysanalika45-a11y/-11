package de.polygonal.ds
{
   public class ArrayConvert
   {
      ...
      public static function toArrayedQueue(param1:Array) : ArrayedQueue
      {
         ...
         var _temp_7:* = §§findproperty(ArrayedQueue);
         var _loc4_:* = _loc2_ - 1;
         _loc4_ |= _loc4_ >> 1;
         _loc4_ |= _loc4_ >> 2;
         _loc4_ |= _loc4_ >> 4;
         _loc4_ |= _loc4_ >> 8;
         _loc4_ |= _loc4_ >> 16;
         var _loc3_:ArrayedQueue = new ArrayedQueue(_loc4_ + 1);
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc5_ = _loc4_++;
            if(_loc3_._capacity == _loc3_._size)
            {
               if(_loc3_._isResizable)
               {
                  ...
                  while(_loc8_ < _loc9_)
                  {
                     ...
                     var _temp_10:* = _loc3_._a;
                     _loc3_._front = (_loc11_ = _loc3_._front) + 1;
                     _temp_12[_temp_11] = _temp_10[_loc11_];
            ...
            var _temp_14:* = _loc3_._a;
            _loc3_._size = (_loc8_ = _loc3_._size) + 1;
            _temp_14[int((_loc8_ + _loc3_._front) % _loc3_._capacity)] = param1[_loc5_];
         }
         return _loc3_;
      }
      ...
      public static function toArrayedStack(param1:Array) : ArrayedStack
      {
         ...
         {
            _loc5_ = _loc3_++;
            var _temp_2:* = _loc2_._a;
            _loc2_._top = (_loc6_ = _loc2_._top) + 1;
            _temp_2[_loc6_] = param1[_loc5_];
         }
         return _loc2_;
      }
      ...
      public static function toSLL(param1:Array) : SLL
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            _loc7_ = _loc2_._reservedSize == 0 || _loc2_._poolSize == 0 ? new SLLNode(_loc6_,_loc2_) : (_loc8_ = _loc2_._headPool,_loc2_._headPool = _loc2_._headPool.next,--_loc2_._poolSize,_loc8_.val = _loc6_,_loc8_.next = null,_loc8_);
            if(_loc2_.tail != null)
            {
