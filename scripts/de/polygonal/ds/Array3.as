package de.polygonal.ds
{
   ...
   public class Array3 implements Collection
   {
      ...
      public var _iterator:Array3Iterator = null;
      
      public var _h:int;
      
      public var _d:int;
      
      public var _a:Array = _loc4_ = new Array(_w * _h * _d);
      
      public function Array3(param1:int, param2:int, param3:int)
      {
         _w = param1;
         _h = param2;
         _d = param3;
      ...
      public function _SafeStr_1(param1:int, param2:int, param3:int, param4:Object) : void
      {
      ...
      {
         var _loc1_:* = null as Array3Iterator;
         var _loc2_:* = null;
         if(reuseIterator)
         {
            if(_iterator == null)
            {
               _iterator = new Array3Iterator(this);
            }
            else
            {
               _loc1_ = _iterator;
               ...
               var _temp_1:* = _loc1_;
               _loc2_ = _loc1_._f;
               _temp_1._s = int(_loc2_._w) * int(_loc2_._h) * int(_loc2_._d);
               _loc1_._i = 0;
               _loc1_;
            }
            return _iterator;
      ...
      public function inRange(param1:int, param2:int, param3:int) : Boolean
      {
         return param1 >= 0 && param1 < _w && param2 >= 0 && param2 < _h && param3 >= 0 && param3 < _d;
      }
      ...
      public function getAt(param1:Array3Cell) : Object
      {
         return _a[param1.z * _w * _h + param1.y * _w + param1.x];
      }
      ...
      public function _SafeStr_2(param1:int, param2:int, param3:int) : Object
      {
