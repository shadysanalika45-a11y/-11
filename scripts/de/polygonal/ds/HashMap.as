package de.polygonal.ds
{
   ...
   public class HashMap implements Map
   {
      ...
      public var _iterator:HashMapValIterator = null;
      ...
      public function toString() : String
      {
         ...
         var _loc1_:String = Sprintf.format("{HashMap, size: %d}",[_size]);
         if(_size == 0)
         {
            return _loc1_;
         }
         ...
         {
            _loc3_ = _loc2_.next();
            _loc1_ += Sprintf.format("  %s -> %s\n",[hx.Std.string(_loc3_),hx.Std.string(_map[_loc3_])]);
         }
         return _loc1_ + ">|";
      }
      ...
      public function _SafeStr_1(param1:Object, param2:Object) : Boolean
      {
      ...
      {
         var _loc1_:* = null as HashMapValIterator;
         ...
         if(reuseIterator)
         {
            if(_iterator == null)
            {
               _iterator = new HashMapValIterator(this);
            }
            else
            {
               _loc1_ = _iterator;
               _loc1_._map = _loc1_._f._map;
               §§push(_loc1_);
               _loc3_ = 0;
               _loc2_ = [];
               _loc4_ = _loc1_._map;
               ...
               §§pop()._keys = _loc2_;
               _loc1_._i = 0;
               _loc1_._s = int(_loc1_._keys.length);
               _loc1_;
            }
            return _iterator;
         }
