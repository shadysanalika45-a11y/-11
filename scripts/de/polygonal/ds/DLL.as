package de.polygonal.ds
{
   ...
   public class DLL implements Collection
   {
      ...
      public function DLL(param1:int = 0, param2:int = -1)
      {
         ...
         if(param1 > 0)
         {
            _headPool = _tailPool = new DLLNode(null,this);
         }
         head = tail = null;
         var _temp_5:* = §§findproperty(key);
         var _temp_3:* = HashKey;
         var _loc4_:int;
         _temp_3._counter = (_loc4_ = int(_temp_3._counter)) + 1;
         key = _loc4_;
         reuseIterator = false;
      }
      ...
      {
         var _loc5_:int = 0;
         var _loc1_:String = Sprintf.format("{DLL, size: %d, circular: %s}",[_size,isCircular()]);
         if(_size == 0)
         {
            return _loc1_;
         }
      ...
      public function prependNode(param1:DLLNode) : void
      {
         param1.next = head;
         if(head != null)
         {
      ...
      {
         var _loc3_:DLLNode = param2 == null ? head : param2;
         if(_circular)
         {
            while(_loc3_ != tail)
            {
      ...
      {
         var _loc3_:DLLNode = param2 == null ? tail : param2;
         if(_circular)
         {
            while(_loc3_ != head)
            {
      ...
      public function join(param1:String) : String
      {
         ...
         if(_size > 0)
         {
            ...
            {
               _loc6_ = _loc4_++;
               _loc2_ += hx.Std.string(_loc3_.val) + param1;
               _loc3_ = _loc3_.next;
            }
            _loc2_ += hx.Std.string(_loc3_.val);
         }
         return _loc2_;
      }
      ...
      public function createNode(param1:Object) : DLLNode
      {
      ...
      public function clone(param1:Boolean = true, param2:Function = undefined) : Collection
      {
         ...
         if(_size == 0)
         {
            _loc4_ = new DLL(_reservedSize,maxSize);
            if(_circular)
            {
      ...
      public function appendNode(param1:DLLNode) : void
      {
         if(tail != null)
         {
            tail.next = param1;
      ...
      public function _insertionSortComparable(param1:DLLNode) : DLLNode
      {
         ...
         while(_loc3_ != null)
         {
            ...
            _loc5_ = _loc3_.prev;
            _loc6_ = _loc3_.val;
            if(_loc5_.val.compare(_loc6_) < 0)
            {
               _loc7_ = _loc5_;
               while(_loc7_.prev != null)
               {
                  if(_loc7_.prev.val.compare(_loc6_) >= 0)
                  {
                     break;
                  }
                  _loc7_ = _loc7_.prev;
