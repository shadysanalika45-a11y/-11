package de.polygonal.core.fmt
{
   ...
   public class NumberFormat
   {
      ...
      public static function toBin(param1:int, param2:String = undefined, param3:Boolean = false) : String
      {
         ...
         _loc6_ += _loc6_ >> 16;
         _loc6_ -= _loc6_ >> 1 & 0x55555555;
         _loc6_ = (_loc6_ >> 2 & 0x33333333) + (_loc6_ & 0x33333333);
         var _temp_12:*;
         var _loc4_:* = 32 - ((_loc5_ = param1) < 0 ? 0 : (_loc5_ |= _loc5_ >> 1,_loc5_ |= _loc5_ >> 2,_loc5_ |= _loc5_ >> 4,_loc5_ |= _loc5_ >> 8,_loc5_ |= _loc5_ >> 16,_temp_12 = 32,_loc6_ = _loc5_,_loc6_ = (_loc6_ >> 4) + _loc6_ & 0x0F0F0F0F,_loc6_ += _loc6_ >> 8,_temp_12 - (_loc6_ & 0x3F)));
      ...
      public static function toHex(param1:int) : String
      {
         ...
         while(param1 != 0)
         {
            _loc2_ = _loc3_[param1 & 0x0F] + _loc2_;
            param1 >>>= 4;
         }
         return _loc2_;
      }
      ...
      public static function toFixed(param1:Number, param2:int) : String
      {
         ...
         _loc7_ = _loc6_;
         _loc3_ = _loc7_;
         _loc8_ = hx.Std.string(int(param1 * _loc3_) / _loc3_);
      ...
      public static function toMMSS(param1:Number) : String
      {
         param1 *= 1000;
      ...
      public static function groupDigits(param1:int, param2:String = undefined) : String
      {
         ...
         _loc4_ /= 3;
         var _loc5_:String = hx.Std.string(param1);
         if(_loc4_ == 0)
         {
            return _loc5_;
         }
