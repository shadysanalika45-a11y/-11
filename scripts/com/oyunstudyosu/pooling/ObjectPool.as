package com.oyunstudyosu.pooling
{
   ...
   public class ObjectPool
   {
      ...
      private var _idealArrayInitialSize:uint = 10;
      
      private var _strictMode:Boolean;
      
      public function ObjectPool(param1:Class, param2:Boolean = false, param3:uint = 0, param4:uint = 0, param5:Object = null, param6:String = "", param7:String = "")
      {
         super();
      ...
      public function returnObject(param1:*) : void
      {
         ...
         if(this._strictMode)
         {
            _loc4_ = int(this._objectsInUse.indexOf(param1));
            if(_loc4_ == -1)
            {
               _loc3_ = true;
            }
      ...
      private function addToPool(param1:*, param2:Boolean = false) : void
      {
         ...
         this._pool[this._bufferSize++] = param1;
      }
