   ...
   public class RoomModel implements IRoomModel
   {
      ...
      public function checkMap(param1:Object) : void
      {
         ...
         if(roomData)
         {
            ...
            try
            {
               ContractLogger.log("room_data",{
                  "doorKey":roomData.room.doorKey,
                  "mapLen":roomData.room.map ? String(roomData.room.map).length : 0
               });
            }
            catch(e0c:Error)
            {
      ...
      private function set map(param1:String) : void
      {
         ...
         try
         {
            ContractLogger.log("map_decode",{
               "base64Len":param1 ? param1.length : 0
            });
         }
         catch(e1c:Error)
         {
         ...
         try
         {
            ContractLogger.log("map_decoded",{
               "xmlLen":_map ? _map.toXMLString().length : 0
            });
         }
         catch(e2c:Error)
         {
