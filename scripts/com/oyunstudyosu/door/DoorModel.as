   ...
   public class DoorModel implements IDoorModel
   {
      ...
      public function load(param1:Array) : void
      {
         ...
         while(_loc4_ < param1.length)
         {
            ...
            try
            {
               ContractLogger.log("door_entry",{
                  "key":_loc2_.key,
                  "targetX":_loc2_.targetX,
                  "targetY":_loc2_.targetY,
                  "targetDir":_loc2_.targetDir,
                  "property":_loc2_.property
               });
            }
            catch(eD:Error)
            {
      ...
      public function loadJSON(param1:String) : void
      {
         ...
         try
         {
            ContractLogger.log("doors_json",{
               "length":param1 ? param1.length : 0,
               "count":_loc2_ ? _loc2_.length : 0
            });
         }
         catch(eJ:Error)
         {
