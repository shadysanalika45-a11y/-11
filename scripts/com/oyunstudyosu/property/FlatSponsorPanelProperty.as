package com.oyunstudyosu.property
{
   ...
   public class FlatSponsorPanelProperty extends Property
   {
      
      private var obj:IEntryVo;
      
      public function FlatSponsorPanelProperty()
      {
         super();
      }
      ...
      override public function execute(param1:String = "") : void
      {
         ...
         trace("FlatSponsorPanelProperty");
         ...
         {
            _loc2_ = new PanelVO("FlatSponsorPanel");
            _loc2_.type = "static";
            _loc2_.params = data;
