package com.smartfoxserver.v2.requests
{
   ...
   public class RoomSettings
   {
      ...
      private var _allowOwnerOnlyInvitation:Boolean;
      ...
      public function RoomSettings(param1:String)
      {
         ...
         this._allowOwnerOnlyInvitation = true;
      }
      ...
      {
         return this._allowOwnerOnlyInvitation;
      }
      
      public function set allowOwnerOnlyInvitation(param1:Boolean) : void
      {
         this._allowOwnerOnlyInvitation = param1;
      }
   }
}
