package com.smartfoxserver.v2.entities.managers
{
   ...
   public class SFSRoomManager implements IRoomManager
   {
      ...
      {
         this._roomsById._SafeStr_1(param1.id,param1);
         this._roomsByName._SafeStr_1(param1.name,param1);
         if(param2)
         {
      ...
      public function replaceRoom(param1:Room, param2:Boolean = true) : Room
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.kernel::merge(param1,this._smartFox.mySelf);
            return _loc3_;
         }
      ...
      public function changeRoomName(param1:Room, param2:String) : void
      {
         ...
         param1.name = param2;
         this._roomsByName._SafeStr_1(param2,param1);
      ...
      public function removeGroup(param1:String) : void
      {
         ...
         var _loc3_:Array = this.getRoomListFromGroup(param1);
         for each(_loc2_ in _loc3_)
         {
            if(!_loc2_.isJoined)
            {
               this.removeRoom(_loc2_);
            }
            else
            {
               _loc2_.isManaged = false;
            }
         }
      }
      ...
      public function containsRoomInGroup(param1:*, param2:String) : Boolean
      {
         ...
         var _loc4_:Array = this.getRoomListFromGroup(param2);
         var _loc5_:Boolean = false;
         var _loc6_:* = typeof param1 == "number";
      ...
      {
         return this._roomsById._SafeStr_2(param1) as Room;
      }
      
      public function getRoomByName(param1:String) : Room
      {
         return this._roomsByName._SafeStr_2(param1) as Room;
      }
      ...
      public function getRoomListFromGroup(param1:String) : Array
      {
         ...
         var _loc4_:Itr = this._roomsById.iterator();
         while(_loc4_.hasNext())
         {
            _loc2_ = _loc4_.next() as Room;
      ...
      {
         var _loc2_:Room = this._roomsById._SafeStr_2(param1) as Room;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:Room = this._roomsByName._SafeStr_2(param1) as Room;
         if(_loc2_ != null)
         {
