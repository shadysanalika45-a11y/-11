package com.smartfoxserver.v2.entities.managers
{
   ...
   public class SFSUserManager implements IUserManager
   {
      ...
      {
         return this._usersByName._SafeStr_2(param1) as User;
      }
      
      public function getUserById(param1:int) : User
      {
         return this._usersById._SafeStr_2(param1) as User;
      }
      ...
      {
         this._usersByName._SafeStr_1(param1.name,param1);
         this._usersById._SafeStr_1(param1.id,param1);
      }
      ...
      {
         var _loc2_:User = this._usersById._SafeStr_2(param1) as User;
         if(_loc2_ != null)
         {
