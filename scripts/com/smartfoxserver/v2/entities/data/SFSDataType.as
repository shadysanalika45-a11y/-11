package com.smartfoxserver.v2.entities.data
{
   public class SFSDataType
   {
      ...
      private static const TYPE_NAMES:Array = ["NULL","BOOL","BYTE","SHORT","INT","LONG","FLOAT","DOUBLE","UTF_STRING","BOOL_ARRAY","BYTE_ARRAY","SHORT_ARRAY","INT_ARRAY","LONG_ARRAY","FLOAT_ARRAY","DOUBLE_ARRAY","UTF_STRING_ARRAY","SFS_ARRAY","SFS_OBJECT","CLASS","TEXT"];
