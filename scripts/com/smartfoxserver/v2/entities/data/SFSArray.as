package com.smartfoxserver.v2.entities.data
{
   ...
   public class SFSArray implements ISFSArray
   {
      ...
      public function contains(param1:*) : Boolean
      {
         ...
         {
            _loc2_ = this.getElementAt(_loc4_);
            if(_loc2_ != null && _loc2_ == param1)
            {
               _loc3_ = true;
               break;
            }
      ...
      {
         var _loc1_:SFSDataWrapper = null;
         var _loc2_:String = null;
         var _loc3_:int = 0;
         var _loc4_:* = null;
         var _loc5_:String = DefaultObjectDumpFormatter.TOKEN_INDENT_OPEN;
         for(_loc4_ in this.dataHolder)
         {
            _loc1_ = this.dataHolder[_loc4_];
            _loc3_ = _loc1_.type;
            if(_loc3_ == SFSDataType.SFS_OBJECT)
            {
               _loc2_ = (_loc1_.data as SFSObject).getDump(false);
            }
            else if(_loc3_ == SFSDataType.SFS_ARRAY)
            {
               _loc2_ = (_loc1_.data as SFSArray).getDump(false);
            }
            ...
            {
               _loc2_ = DefaultObjectDumpFormatter.prettyPrintByteArray(_loc1_.data as ByteArray);
            }
            else
            {
               _loc2_ = _loc1_.data;
            }
            _loc5_ += "(" + SFSDataType.fromId(_loc1_.type).toLowerCase() + ") ";
            _loc5_ = _loc5_ + _loc2_;
            _loc5_ = _loc5_ + DefaultObjectDumpFormatter.TOKEN_DIVIDER;
         }
         if(this.size() > 0)
         {
            _loc5_ = _loc5_.slice(0,_loc5_.length - 1);
         }
         return _loc5_ + DefaultObjectDumpFormatter.TOKEN_INDENT_CLOSE;
      }
      ...
      {
         this.addObject(param1,SFSDataType.TEXT);
      }
      ...
      public function getBool(param1:int) : Boolean
      {
         ...
         return _loc2_ != null ? Boolean(_loc2_.data as Boolean) : Boolean(undefined);
      }
      ...
      {
         return this.getInt(param1) & 0xFF;
      }
      ...
      {
         var _loc2_:SFSDataWrapper = this.dataHolder[param1];
         return _loc2_ != null ? int(_loc2_.data as int) : int(undefined);
      }
      ...
      {
         var _loc2_:SFSDataWrapper = this.dataHolder[param1];
         return _loc2_ != null ? Number(_loc2_.data as Number) : Number(undefined);
      }
      ...
      {
         return this.getUtfString(param1);
      }
      ...
      public function getUnsignedByteArray(param1:int) : Array
      {
         ...
         {
            _loc3_.push(_loc2_.readByte() & 0xFF);
            _loc4_++;
         }
         return _loc3_;
      }
