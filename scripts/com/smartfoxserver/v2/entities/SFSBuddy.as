package com.smartfoxserver.v2.entities
{
   ...
   public class SFSBuddy implements Buddy
   {
      ...
      {
         var _loc2_:Buddy = new SFSBuddy(param1.getInt(0),param1.getUtfString(1),param1.getBool(2),param1.size() > 3 ? Boolean(param1.getBool(4)) : Boolean(false));
      ...
      public function get isOnline() : Boolean
      {
         ...
         var _loc2_:Boolean = _loc1_ == null ? Boolean(true) : Boolean(_loc1_.getBoolValue());
      ...
      public function get state() : String
      {
         ...
         return _loc1_ == null ? null : _loc1_.getStringValue();
      }
