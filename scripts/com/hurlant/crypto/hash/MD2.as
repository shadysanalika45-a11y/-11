package com.hurlant.crypto.hash
{
   ...
   public class MD2 implements IHash
   {
      ...
      public function hash(param1:ByteArray) : ByteArray
      {
         ...
         _loc3_ = uint(uint(16 - param1.length % 16) || 16);
         do
         {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            while(_loc8_ < 16)
            {
               _loc6_ = uint(_loc5_[_loc8_] = _loc5_[_loc8_] ^ S[param1[_loc3_ + _loc8_] ^ _loc6_]);
               _loc8_++;
            }
            _loc3_ += 16;
         }
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            while(_loc8_ < 18)
            {
               ...
               while(_loc10_ < 48)
               {
                  _loc7_[_loc10_] = _loc9_ = uint(_loc7_[_loc10_] ^ S[_loc9_]);
                  _loc10_++;
               }
               _loc9_ = uint(_loc9_ + _loc8_ & 0xFF);
               _loc8_++;
            }
            _loc3_ += 16;
         }
