package com.hurlant.crypto.symmetric
{
   ...
   public class AESKey implements ISymmetricKey
   {
      ...
      private function expandKey() : void
      {
         ...
         {
            _loc1_ = uint(this.key[4 * _loc6_ - 4]);
            _loc2_ = uint(this.key[4 * _loc6_ - 3]);
            _loc3_ = uint(this.key[4 * _loc6_ - 2]);
            _loc4_ = uint(this.key[4 * _loc6_ - 1]);
            if(!(_loc6_ % _loc7_))
            {
               _loc5_ = _loc4_;
      ...
      protected function addRoundKey(param1:ByteArray, param2:uint) : void
      {
         ...
         while(_loc3_ < 16)
         {
            this.state[_loc3_] ^= param1[_loc3_ + param2];
            _loc3_++;
         }
      }
