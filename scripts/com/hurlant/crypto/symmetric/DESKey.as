   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         while(_loc9_ < 8)
         {
            ...
            _loc10_ = uint(_loc10_ | SP5[_loc6_ >>> 8 & 0x3F]);
            _loc10_ = uint(_loc10_ | SP3[_loc6_ >>> 16 & 0x3F]);
            _loc10_ = uint(_loc10_ | SP1[_loc6_ >>> 24 & 0x3F]);
            _loc6_ = uint(_loc7_ ^ param1[_loc9_ * 4 + 1]);
            _loc10_ |= SP8[_loc6_ & 0x3F];
            _loc10_ = uint(_loc10_ | SP6[_loc6_ >>> 8 & 0x3F]);
            _loc10_ = uint(_loc10_ | SP4[_loc6_ >>> 16 & 0x3F]);
            _loc10_ = uint(_loc10_ | SP2[_loc6_ >>> 24 & 0x3F]);
            _loc8_ ^= _loc10_;
