package com.greensock.plugins
{
   ...
   public class CirclePath2DPlugin extends TweenPlugin
   {
      ...
      override public function onInitTween(param1:Object, param2:*, param3:TweenLite) : Boolean
      {
         ...
         this._change = Number(this._circle.anglesToProgressChange(this._circle.progressToAngle(this._start),Number(param2.endAngle) || 0,param2.direction || "clockwise",uint(param2.extraRevolutions) || 0,Boolean(param2.useRadians)));
         return true;
      }
