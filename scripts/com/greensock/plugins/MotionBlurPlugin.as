package com.greensock.plugins
{
   ...
   public class MotionBlurPlugin extends TweenPlugin
   {
      ...
      private function disable() : void
      {
         ...
         {
            if(_isFlex && Boolean(this._sprite.parent.hasOwnProperty("removeElement")))
            {
      ...
      override public function set changeFactor(param1:Number) : void
      {
         ...
         {
            if(_isFlex && Boolean(this._target.parent.hasOwnProperty("addElement")))
            {
         ...
         _loc7_ = this._matrix.a * this._bdCache.width;
         if(_loc7_ < 0)
         {
            this._matrix.tx = -_loc7_;
            _loc7_ = -_loc7_;
         }
         _loc9_ = this._matrix.c * this._bdCache.height;
         if(_loc9_ < 0)
         {
         ...
         _loc8_ = this._matrix.d * this._bdCache.height;
         if(_loc8_ < 0)
         {
            this._matrix.ty = -_loc8_;
            _loc8_ = -_loc8_;
         }
         _loc9_ = this._matrix.b * this._bdCache.width;
         if(_loc9_ < 0)
         {
