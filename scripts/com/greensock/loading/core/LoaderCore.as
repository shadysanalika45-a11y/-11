package com.greensock.loading.core
{
   ...
   public class LoaderCore extends EventDispatcher
   {
      ...
      protected function _errorHandler(param1:Event) : void
      {
         ...
         _loc2_ = param1 is LoaderEvent && Boolean(this.hasOwnProperty("getChildren")) ? param1.target : this;
      ...
      protected function _failHandler(param1:Event, param2:Boolean = true) : void
      {
         ...
         dispatchEvent(new LoaderEvent(LoaderEvent.FAIL,param1 is LoaderEvent && Boolean(this.hasOwnProperty("getChildren")) ? param1.target : this,this.toString() + " > " + (param1 as Object).text));
      }
