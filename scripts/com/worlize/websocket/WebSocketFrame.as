package com.worlize.websocket
{
   ...
   public class WebSocketFrame
   {
      ...
      public function addData(param1:IDataInput, param2:int, param3:WebSocketConfig) : Boolean
      {
         ...
         if(param1.bytesAvailable >= 2)
         {
            if(this.parseState === NEW_FRAME)
            {
               ...
               this.fin = Boolean(_loc4_ & 0x80);
               this.rsv1 = Boolean(_loc4_ & 0x40);
               this.rsv2 = Boolean(_loc4_ & 0x20);
               this.rsv3 = Boolean(_loc4_ & 0x10);
               this.mask = Boolean(_loc5_ & 0x80);
      ...
      public function send(param1:IDataOutput) : void
      {
         ...
         {
            _loc2_ = Math.ceil(Math.random() * 4294967295);
