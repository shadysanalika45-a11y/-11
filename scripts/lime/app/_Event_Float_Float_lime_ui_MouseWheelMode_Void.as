package lime.app
{
   ...
   public class _Event_Float_Float_lime_ui_MouseWheelMode_Void
   {
      ...
      public function _Event_Float_Float_lime_ui_MouseWheelMode_Void()
      {
      ...
      public function dispatch(param1:Number, param2:Number, param3:MouseWheelMode) : void
      {
         canceled = false;
         var _loc4_:Array = __listeners;
         var _loc5_:Array = __repeat;
         var _loc6_:int = 0;
