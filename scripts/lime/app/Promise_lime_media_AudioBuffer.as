package lime.app
{
   ...
   public class Promise_lime_media_AudioBuffer
   {
      ...
      public function Promise_lime_media_AudioBuffer()
      {
      }
      
      public function progress(param1:int, param2:int) : Promise_lime_media_AudioBuffer
      {
         var _loc3_:int = 0;
      ...
      public function error(param1:*) : Promise_lime_media_AudioBuffer
      {
         var _loc2_:int = 0;
      ...
      public function completeWith(param1:Future) : Promise_lime_media_AudioBuffer
      {
      ...
      public function complete(param1:AudioBuffer) : Promise_lime_media_AudioBuffer
      {
         var _loc2_:int = 0;
         var _loc3_:* = null as Array;
         var _loc4_:* = null as Function;
