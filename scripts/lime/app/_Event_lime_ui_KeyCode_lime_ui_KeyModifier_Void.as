package lime.app
{
   ...
   public class _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void
   {
      ...
      public function _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void()
      {
      ...
      public function dispatch(param1:int, param2:int) : void
      {
         canceled = false;
         var _loc3_:Array = __listeners;
