package lime.app
{
   ...
   public class _Event_lime_graphics_RenderContext_Void
   {
      ...
      public function _Event_lime_graphics_RenderContext_Void()
      {
      ...
      public function dispatch(param1:RenderContext) : void
      {
         canceled = false;
