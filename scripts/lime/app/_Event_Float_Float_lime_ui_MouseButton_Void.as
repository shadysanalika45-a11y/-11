package lime.app
{
   ...
   public class _Event_Float_Float_lime_ui_MouseButton_Void
   {
      ...
      public function _Event_Float_Float_lime_ui_MouseButton_Void()
      {
      ...
      public function dispatch(param1:Number, param2:Number, param3:int) : void
      {
         canceled = false;
